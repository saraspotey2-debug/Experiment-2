...
3. Accessing elements of list- To print only a particular element. Example-print(numbers[4])-will give 5th element of list as indexing starts from 0.
...
4. Calculating average marks by calculating the sum and then the lenght of the list, dividing them and displaying it.
